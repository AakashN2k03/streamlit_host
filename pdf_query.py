...
# Specify the static PDF file path (use raw string)
STATIC_PDF_PATH = "mern_eventify_PDF.pdf"  # Update this path to your static PDF
...
def main():
    st.set_page_config("AAKASH's EVENTIFY")
    st.header("Chat with AAKASH's EVENTIFY😎 ")
